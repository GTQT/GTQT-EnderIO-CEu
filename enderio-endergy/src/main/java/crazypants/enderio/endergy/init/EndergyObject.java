...
public enum EndergyObject implements IModObjectBase {
  ...
  itemCapacitorElectrum(ItemEndergyCapacitor::create_electrum),
  ...
  itemCapacitorLithiumCadmium(ItemEndergyCapacitor::create_lithium_cadmium),
  itemCapacitorVanadium(ItemEndergyCapacitor::create_vanadium),
  itemCapacitorNiobiumTitanium(ItemEndergyCapacitor::create_niobium_titanium),
  itemCapacitorNaquadah(ItemEndergyCapacitor::create_naquadah),
  itemCapacitorEnrichedNaquadah(ItemEndergyCapacitor::create_enriched_naquadah),
  itemCapacitorEuropium(ItemEndergyCapacitor::create_europium),
  itemCapacitorNaquadria(ItemEndergyCapacitor::create_naquadria),
  itemCapacitorAmericium(ItemEndergyCapacitor::create_americium),
  itemCapacitorTritanium(ItemEndergyCapacitor::create_tritanium),
  itemCapacitorDuranium(ItemEndergyCapacitor::create_duranium),
  itemCapacitorNeutronium(ItemEndergyCapacitor::create_neutronium),
